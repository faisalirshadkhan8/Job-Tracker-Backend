...
def ai_task(user):
    ...
    return AITask.objects.create(
        ...
        status="pending",
        input_params={"company_name": "Test Corp", "job_title": "Developer", "tone": "professional"},
    )
...
class TestAITaskModel:
    ...
    def test_create_ai_task(self, user):
        ...
        task = AITask.objects.create(user=user, task_type="cover_letter", status="pending")
...
class TestAITaskViewSet:
    ...
    def test_cannot_access_other_users_task(self, auth_client, another_user):
        ...
        other_task = AITask.objects.create(user=another_user, task_type="cover_letter", status="pending")
