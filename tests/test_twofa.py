...
from apps.twofa.models import BackupCode, TwoFactorDevice
...
class TestTwoFactorSetup:
    ...
    def test_confirm_2fa_valid_code(self, auth_client, user):
        ...
        # Setup 2FA first
        device = TwoFactorDevice.objects.create(user=user, secret=pyotp.random_base32())
    ...
    def test_confirm_2fa_invalid_code(self, auth_client, user):
        ...
        TwoFactorDevice.objects.create(user=user, secret=pyotp.random_base32())
    ...
    def test_setup_2fa_already_enabled(self, auth_client, user):
        ...
        TwoFactorDevice.objects.create(user=user, secret=pyotp.random_base32(), is_enabled=True, is_verified=True)
...
class TestTwoFactorVerification:
    ...
    def enabled_2fa(self, user):
        ...
        device = TwoFactorDevice.objects.create(
            user=user, secret=pyotp.random_base32(), is_enabled=True, is_verified=True
        )
    ...
    def test_verify_backup_code(self, auth_client, user, enabled_2fa):
        ...
        # Get a backup code
        backup_code = BackupCode.objects.filter(device=enabled_2fa, is_used=False).first()
...
class TestTwoFactorDisable:
    ...
    def test_disable_2fa_valid(self, auth_client, user, enabled_2fa):
        ...
        response = auth_client.post(url, {"code": valid_code, "password": "testpass123"})
    ...
    def test_disable_2fa_wrong_password(self, auth_client, user, enabled_2fa):
        ...
        url = reverse("2fa-disable")
        response = auth_client.post(url, {"code": valid_code, "password": "wrongpassword"})
    ...
    def test_disable_2fa_wrong_code(self, auth_client, user, enabled_2fa):
        ...
        url = reverse("2fa-disable")
        response = auth_client.post(url, {"code": "000000", "password": "testpass123"})
