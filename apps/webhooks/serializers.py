...
class WebhookEndpointSerializer(serializers.ModelSerializer):
    ...
    events = serializers.ListField(child=serializers.ChoiceField(choices=[e[0] for e in WebhookEndpoint.EVENT_CHOICES]))
...
class WebhookTestSerializer(serializers.Serializer):
    ...
    event = serializers.ChoiceField(
        choices=[e[0] for e in WebhookEndpoint.EVENT_CHOICES], default="application.created"
    )
