...
class WebhookEndpointAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ['id', 'secret', 'failure_count', 'last_failure_at', 
                       'last_success_at', 'created_at', 'updated_at']
    
    fieldsets = [
        (None, {
            'fields': ['id', 'user', 'name', 'url', 'secret', 'events', 'is_active']
        }),
        ('Statistics', {
            'fields': ['failure_count', 'last_failure_at', 'last_success_at']
        }),
        ('Timestamps', {
...
class WebhookDeliveryAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ['id', 'endpoint', 'event', 'payload', 'status', 
                       'attempt_count', 'response_status_code', 'response_body',
