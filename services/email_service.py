...
class EmailService:
    ...
    def send_verification_email(cls, user, verification_url: str) -> dict:
        ...
        html_content = render_to_string(
            ...
            {"user": user, "verification_url": verification_url, "app_name": "Job Application Tracker"},
        )
...
The Job Application Tracker Team
        ...
        return cls.send_email(to=[user.email], subject=subject, html_content=html_content, text_content=text_content)
    ...
    def send_password_reset_email(cls, user, reset_url: str) -> dict:
        ...
        html_content = render_to_string(
            "emails/password_reset.html", {"user": user, "reset_url": reset_url, "app_name": "Job Application Tracker"}
        )
...
The Job Application Tracker Team
    ...
    def send_welcome_email(cls, user) -> dict:
        ...
        html_content = render_to_string("emails/welcome.html", {"user": user, "app_name": "Job Application Tracker"})
...
The Job Application Tracker Team
    ...
    def send_password_changed_email(cls, user) -> dict:
        ...
        html_content = render_to_string(
            "emails/password_changed.html", {"user": user, "app_name": "Job Application Tracker"}
        )
